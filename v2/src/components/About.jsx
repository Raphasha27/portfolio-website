      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight">
                Building the <span className="text-blue-400">Future</span><br className="hidden sm:block" /> with Code
              </h2>
            ...
            <div className="hidden sm:flex px-5 py-2 rounded-full bg-blue-500/10 border border-blue-500/30 items-center gap-2 shrink-0 self-start">
          ...
          <div className="space-y-6 sm:space-y-10 pt-6 sm:pt-8 border-t border-white/5">
            <div>
              <div className="text-[11px] text-blue-400 font-bold uppercase tracking-[0.15em] sm:tracking-[0.4em] mb-1">Certification &amp; Institutional Partners</div>
              <div className="text-white/30 text-[9px] font-mono uppercase tracking-[0.1em] sm:tracking-widest">8 Accredited Institutions &amp; Platforms</div>
            </div>
