        ...
        {services.map((service, i) => (
          <div key={i} className="glass p-8 text-center group hover:border-green-500/50 transition-all duration-500 rounded-[32px] relative overflow-hidden shadow-[0_0_15px_rgba(0,0,0,0.5)] hover:shadow-[0_0_40px_rgba(0,229,160,0.15)] hover:-translate-y-2">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-[#0a161d] flex items-center justify-center text-green-400 mx-auto mb-8 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_20px_rgba(0,201,136,0.1)] border border-green-500/20 group-hover:border-green-400 relative">
                {/* Ping animation behind icon */}
                <div className="absolute inset-0 bg-green-400 rounded-2xl opacity-0 group-hover:animate-ping pointer-events-none"></div>
